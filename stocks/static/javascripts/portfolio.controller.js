...
(function(){
  ...
  portfolioController.$inject = ['$scope','Layout','$interval','$window','$timeout','$http','$rootScope','$state'];

  function portfolioController($scope,Layout, $interval,$window,$timeout,$http,$rootScope,$state){
    ...
    vm.setInterval = vm.refreshOptionList[1];
