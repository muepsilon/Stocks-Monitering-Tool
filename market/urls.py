...
urlpatterns = [
    ...
    url(r'^api/accounts/signup/$', login_views.registerUser, name="register_user"),
    url(r'^api/company/keyratios/$',views.fetch_or_return_company_key_ratios, name="fetch_or_return_company_key_ratios"),
    ...
    url(r'^api/fetch_ipo_info/$',views.fetch_ipo_info, name="Fetch IPO info"),
